...
We then look a three different strategies for nodes to create Sybils in the network, allowing for a more tactical approach for creating churn and affecting the runtime.



\subsection{Induced Churn}
In this strategy, we rely solely on churn to perform load balancing.
This churn can either be a product of normal network activity or self-induced.\footnote{All distributed systems experience churn, even if it only a matter of hardware failure.}
