...
At the first glance, neighbor injection does not seem to be doing worse than no strategy; 
...
\begin{figure}
	...
	\caption[Neighbor injection vs no strategy after 5 ticks.]{}
...
\begin{figure}
	...
	\caption[Neighbor injection  vs no strategy after 35 ticks.]{}
...
\caption[Smart neighbor injection vs no strategy after 5 ticks.]{}
...
\begin{figure}
	...
	\caption[Smart Neighbor injection  vs no strategy after 35 ticks.]{}
...
Overall, the neighbor injection strategy did not perform as well as the random injection strategy, but generates much less churn from joining nodes, since nodes can create their Sybils in a greatly reduced range.
\subsection{Invitation}
