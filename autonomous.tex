...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figs/workloadDistribution}
...
\begin{enumerate}
	...
	We consider the tick the amount of time it takes a node to complete one task per Sybil and perform the appropriate maintenance.\footnote{If we need to be more concrete, define a tick as a New York Second ``defined as the period of time between the traffic lights turning green and the cab behind you honking.''\\-- Terry Pratchett}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figs/churnVsTime}
...
One facet not captured by our simulations, but would have a significant effect after 
