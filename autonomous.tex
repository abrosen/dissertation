...
\begin{table}[h]
	...
	\centering
	\caption[Churn Runtimes in a homogenious network]{Average runtime factor of networks of varying sizes and number of tasks, each using the Churn strategy to load-balance.  The networks are homogeneous and each node consumes one task per tick.}
	\begin{tabular}{|r || r | r | r | r |}
		\hline
		Churn Rate & $ 10^{3}$ nodes, $ 10^{5}$ tasks & $ 10^{3}$ nodes, $ 10^{6}$ tasks & $ 100$ nodes, $ 10^{4}$ tasks & $ 100$ nodes, $ 10^{6}$ tasks \\ \hline
		0      & 7.476   &  7.467 &  5.043& 5.016 \\\hline
		0.0001 & 7.122   &  5.732 &  4.934 & 3.077 \\\hline
		0.001  & 6.047   &  3.674 &  4.391& 1.863\\\hline
		0.01  &  3.721   &  2.104 &  3.076& 1.309\\\hline
...
We ran additional experiments on rates of churn for a 1000 node network and 100,000 tasks.
...
The runtime for heterogeneous versus homogeneous networks had no significant difference.


How did scaling affect the network?  
The variable that most affected the base runtime factor for Churn (and for networks with no strategy) is not
...
\caption[Workload for churn at tick 0]{Foo}
...
\caption[Workload for churn at tick 5]{Bar}
...
\begin{figure}
	...
	\caption[Workload for churn at tick 35]{Baz}
