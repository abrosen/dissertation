...
This means queries of other nodes and Sybil injections only occur when they need to, greatly reducing the maintenance costs in an actual simulation.

Invitation was unaffected by varaibles (double check)
