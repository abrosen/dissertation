...
Ratios seem to have similar run times

Churn had no positive impact on the runtime factor and at higher levels could begin having an extremely minor impact when churn is at 0.01 per tick, increasing the aaverage runtime factor by approximately 0.06 
\subsection{Neighbor Injection}
