...
\begin{abstract}
Distributed Hash Tables (DHTs) are an integral foundation for a variety of modern internet applications, such as BitTorrent, which accounts 30-40\% of North American uplink traffic, and blockchain based applications, such as bitcoin.

In previous work, we have shown that DHTs can also be used as a means to organize a large number of workers to tackle a large scale computing problem in a fault tolerant context.
