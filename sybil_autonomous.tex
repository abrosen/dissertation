...
Most distributed computing paradigms assume that the computations occur in a centralized environments, if not explicitly designed to be used in large datacenters \cite{hadoopAssumptions} and the majority of research has been focused there.
